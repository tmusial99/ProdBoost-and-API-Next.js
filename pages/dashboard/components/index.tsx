            ...
            <Container>
                ...
                <Group position='center'>
                    <Link href='/dashboard/components/add' passHref>
                        <Button component='a' radius='xl' leftIcon={<CirclePlus size={22}/>} sx={{'@media (max-width: 571px)': {minWidth: '100%'}}}>Dodaj nowy komponent</Button>
                    </Link>
                    <TextInput icon={<Search/>} type='search' radius='xl' value={searchValue} placeholder='Szukaj komponentów...' onChange={(e) => setSearchValue(e.target.value)} sx={{maxWidth: '300px', width: '100%', '@media (max-width: 571px)': {minWidth: '100%'}}}/>
                </Group>
