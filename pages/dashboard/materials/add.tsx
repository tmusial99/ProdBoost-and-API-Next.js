...
const items = [
    ...
    { title: 'Dodaj nowy materiał', href: ''}
]
...
export default function Page(){
    ...
    const sendData = async () => {
        setSendingData(true);
        try{
            const res = await axios.post('/api/materials/add', form)
            router.replace(`/dashboard/materials/${res.data}`)
        }
        catch(e){
    ...
    return(
        <>
            ...
            <Container>
                ...
                <Title order={1} mb={20} align='center'>Dodaj nowy materiał</Title>
